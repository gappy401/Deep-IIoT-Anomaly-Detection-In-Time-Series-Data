...
<div align="center">
  <img src="4-Figure2-1.png" alt="General Architecture Provided in the Paper" style="width: 80%; border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/>
</div>
